...
/**
 * Cevapsız teklifleri tespit eder (koordinatöre bildirir), bildirimden sonra da
 * hâlâ cevapsızsa hükmen mağlubiyet uygular. 15 günü geçen pasif oyuncuları
 * otomatik olarak aktif hale getirir. Hem günlük hem haftalık cron tarafından
 * çağrılabilir.
 */
export async function runMaintenanceTasks(admin) {
  ...
  // 1) 3 gün cevapsız teklifler -> koordinatöre bildir
  ...
  // 2) Koordinatöre bildirimden NO_RESPONSE_FORFEIT_DAYS sonra hâlâ cevapsızsa hükmen mağlubiyet
  ...
  // 3) 15 günü geçen pasif oyuncuları otomatik aktif et
